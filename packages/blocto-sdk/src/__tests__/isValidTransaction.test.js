import { isValidTransaction, isValidTransactions } from "../lib/isValidTransaction";
...
describe("isValidTransaction", () => {
  ...
  it("should return invalid when passing invalid transaction without 'from'", () => {
    ...
    expect(isValidTransaction(mockTransaction)).toEqual({ isValid: false, invalidMsg: ERROR_MESSAGE.INVALID_TRANSACTION });
  });
  ...
  it("should return invalid when passing transaction with invalid 'value'", () => {
    ...
    expect(isValidTransaction(mockTransaction)).toEqual({ isValid: false, invalidMsg: ERROR_MESSAGE.INVALID_TRANSACTION_VALUE });
  });
});
...
describe("isValidTransactions", () => {
  ...
  it("should return invalid when passing invalid array of transactions", () => {
    ...
    expect(isValidTransactions(mockTransactions)).toEqual({ isValid: false, invalidMsg: ERROR_MESSAGE.INVALID_TRANSACTIONS });
  });
  ...
  it("should return invalid when passing contain invalid transactions", () => {
    ...
    expect(isValidTransactions(mockTransactions)).toEqual({ isValid: false, invalidMsg: ERROR_MESSAGE.INVALID_TRANSACTION_VALUE });
  });
});
